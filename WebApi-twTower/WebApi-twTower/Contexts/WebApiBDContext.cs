...
namespace WebApi_twTower.Contexts
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-FIGF85J\\SQLEXPRESS; Initial Catalog=WebApiBD; Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Jogador>(entity =>
            {
                ...
                entity.HasOne(d => d.Selecao)
                    ...
                    .HasConstraintName("FK__Jogador__Selecao__3B75D760");
            });
